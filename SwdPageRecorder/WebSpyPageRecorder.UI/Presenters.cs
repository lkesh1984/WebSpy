...
namespace WebSpyPageRecorder.UI
{
    ...
    {
        private static WebSpyMainPresenter _WebSpyMainPresenter = null;
        public static WebSpyMainPresenter WebSpyMainPresenter
        {
            get
            {
                return (_WebSpyMainPresenter = _WebSpyMainPresenter ?? new WebSpyMainPresenter());
            }
        }
