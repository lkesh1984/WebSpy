...
using System.IO;
using WebSpyPageRecorder.ConfigurationManagement.MyConfigurationMappings;
using WebSpyPageRecorder.ConfigurationManagement;

namespace WebSpyPageRecorder.UI
{
    public class WebSpyMainPresenter
    {
        ...
        private WebSpyMainView view;
        public IWebDriver Driver { get { return WebSpyBrowser.GetDriver(); } }
        ...
        public void InitView(WebSpyMainView view)
        {
            this.view = view;
            ...
            WebSpyBrowser.OnDriverStarted += InitSwitchToControls;
            ConfigureView();
            InitControls();
        }
