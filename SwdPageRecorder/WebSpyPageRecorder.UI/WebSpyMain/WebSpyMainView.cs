...
using WebSpyPageRecorder.UI.WebSpyMain.Popups;


namespace WebSpyPageRecorder.UI
{
    public partial class WebSpyMainView : Form, IView
    {
        private WebSpyMainPresenter presenter = null;
        private System.Threading.ManualResetEvent startedEvent;
        
        public WebSpyMainView()
        {
            InitializeComponent();
            string versionText = string.Format("Web Page Spy {0} (Build: {1})", Build.WebDriverVersion, Build.Version);
            this.Text = versionText;
            MyLog.Write("Started: " + versionText);
            this.AutoScaleMode = System.Windows.Forms.AutoScaleMode.Dpi;

            presenter = Presenters.WebSpyMainPresenter;
            presenter.InitView(this);
        }

        public WebSpyMainView(System.Threading.ManualResetEvent startedEvent) : this()
        {
        ...
        {
            System.Diagnostics.Process.Start(@"http://www.msn.com/en-in/");
        }
        ...
        private void WebSpyMainView_Shown(object sender, EventArgs e)
        {
