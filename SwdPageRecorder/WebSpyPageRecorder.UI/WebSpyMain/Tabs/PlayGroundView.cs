...
driver.Navigate().GoToUrl(""http://www.msn.com/en-in/"");
driver.GetScreenshot().SaveAsFile(""Screenshots\\mywebpagetest.png"", ImageFormat.Png); // See <WebSpyRecorder.exe-folder>\Screenshots
";
