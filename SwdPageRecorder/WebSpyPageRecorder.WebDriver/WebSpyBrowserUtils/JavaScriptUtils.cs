...
namespace WebSpyPageRecorder.WebDriver.WebSpyBrowserUtils
{
    public static class JavaScriptUtils
    {
        ...
        internal static void DestroyVisualSearch(IWebDriver webDriver)
        {
            ...
            {
                "document.WebSpy_Page_Recorder",
                "document.WebSpy_prevActiveElement",
                "document.WebSpypr_command",
            };
        ...
        {
            string jsCheckScript = @"return document.WebSpy_Page_Recorder === undefined ? 'false' : 'true';";
            IJavaScriptExecutor jsExec = webDriver as IJavaScriptExecutor;
