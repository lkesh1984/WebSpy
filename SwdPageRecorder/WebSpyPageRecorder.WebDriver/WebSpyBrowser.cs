...
using WebSpyPageRecorder.WebDriver.WebSpyBrowserUtils;
using WebSpyPageRecorder.WebDriver.OpenQA.Selenium.Support.PageObjects;


namespace WebSpyPageRecorder.WebDriver
{
    public static class WebSpyBrowser
    {
        ...
        { 
            get {
                    lock (lockObject)
                    {
                        return WebSpyBrowser.GetDriver().Url;
                    }
                } 
            set {
                    lock (lockObject)
                    {
                        WebSpyBrowser.GetDriver().Url = value;
                    }
                }
        }
        ...
        public static void Maximize()
        {
            lock (lockObject)
            {
                WebSpyBrowser.GetDriver().Manage().Window.Maximize();
            }
        }
