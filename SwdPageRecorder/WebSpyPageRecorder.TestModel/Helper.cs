...
namespace WebSpyPageRecorder.TestModel
{
    public static class Helper
    {
        ...
        {
            var element = WebSpyBrowser.GetDriver().FindElement(By.Id(elementId));
            element.Click();
        }
        ...
        {
            return Path.Combine(Helper.AssemblyDirectory(), "WebSpyPageRecorder.UI.exe");
        }
